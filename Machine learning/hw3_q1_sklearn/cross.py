...
for i in range(10, 30000, 10):
    ...
    mlp_result = mlp.fit(train_split, train_split)
    # Prediction
    train_out = mlp.predict(train_split)
    test_out = mlp.predict(test_split)
    error = mean_squared_error(test_split, test_out)
